...
const DISPLAY_OPTION_SECTIONS = [
	...
	},
	{
		...
		options: [
			...
			{ key: 'show_email_button', label: __('Show email results button', 'pressprimer-quiz'), tooltip: __('Show a button that lets the student email a copy of their results to their own address.', 'pressprimer-quiz') },
